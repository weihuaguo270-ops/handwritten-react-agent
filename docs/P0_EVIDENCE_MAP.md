...
| **评得清不清** | Judge 与人标一致吗 | [llm-eval-engine κ v2](https://github.com/weihuaguo270-ops/llm-eval-engine/blob/master/docs/calibration_snapshot_20260716.md) | offline **n=28**，κ≈**0.90**（旧基线 n=15 κ≈0.47） |
...
- κ offline 已升至 ≈0.90（n=28，协议收紧后冻结分）；live 仍需 `--live` 验证，勿与生产 SLA 等同  
