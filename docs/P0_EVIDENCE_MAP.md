...
- κ：**分栏引用** — held_out（协议冻结后）优先于全量 offline；live 与 offline 勿混谈；单人标注、第二标注者 pending  
